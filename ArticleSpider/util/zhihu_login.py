...
class ZhiHu(object):
    def __init__(self):
        ...
        self.phone = '13733439977'  # 账号
        self.password = 'mei19971207'  # 密码
        self.username = '槑槑'  # 用户名，用于验证登陆
        self.headers = {
        ...
        with open(os.path.join(path, "get_formdata.js"), 'r', encoding='utf-8') as f:
    ...
    def get_form_data(self, signature, captcha):
        text = "client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&timestamp={0}&" \
               ...
               "captcha={4}&lang=cn&ref_source=homepage&utm_source=".format(self.timestamp, signature, self.phone,
    ...
    def login(self, encry):
        ...
        response = self.session.post(url, headers=self.headers, data=encry)

    def verify_login(self, ):
        r = self.session.get('https://www.zhihu.com/notifications', headers=self.headers, allow_redirects=False)
